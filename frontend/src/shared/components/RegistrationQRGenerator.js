...
function RegistrationQRGenerator({ onClose }) {
  ...
  const generateQR = useCallback(async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/registration/create-qr`, {
        method: 'POST',
        headers: {
  ...
  const copyLink = () => {
    ...
    navigator.clipboard.writeText(qrData.registrationUrl)
      .then(() => {
        setCopied(true);
          ...
          {!qrData ? (
            <div className="registration-form">
              ...
              <div className="form-group">
                ...
                {!formData.doctor && (
                  <small className="help-text">Please select a doctor first</small>
                )}
              </div>
            ...
            <>
              <p className="qr-instructions">
                Share this QR code with the new patient to complete their registration
              </p>
              ...
              <div className="qr-footer">
                <p className="security-note">
                  The patient will complete their registration through this link.
                </p>
                {formData.doctor && formData.nurse && formData.room && (
                  <div className="registration-summary">
                    <p><strong>Pre-assigned:</strong></p>
